...
DROP POLICY IF EXISTS "Users can create email templates in their company" ON email_templates;
CREATE POLICY "Users can create email templates in their company"
  ON email_templates FOR INSERT
  WITH CHECK (company_id = get_user_company(auth.uid()));

DROP POLICY IF EXISTS "Users can update email templates in their company" ON email_templates;
