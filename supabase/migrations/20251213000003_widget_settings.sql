...
-- Comments
COMMENT ON TABLE widget_settings IS 'Configuration for embeddable chat widget per company';
COMMENT ON TABLE widget_visitors IS 'Anonymous visitors who interact with the widget';
COMMENT ON TABLE widget_conversations IS 'Conversations initiated through the widget';
