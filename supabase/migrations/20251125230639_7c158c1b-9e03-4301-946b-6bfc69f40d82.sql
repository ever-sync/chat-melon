...
-- RLS Policies
DROP POLICY IF EXISTS "Users can view insights in their company" ON ai_insights;
CREATE POLICY "Users can view insights in their company"
  ON ai_insights FOR SELECT
  USING (company_id = get_user_company(auth.uid()));

DROP POLICY IF EXISTS "Users can update insights in their company" ON ai_insights;
...
DROP POLICY IF EXISTS "Admins can delete insights" ON ai_insights;
