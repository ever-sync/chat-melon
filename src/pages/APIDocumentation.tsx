    ...
    const endpoints = [
        ...
        },
        {
            ...
            items: [
                ...
                { method: "GET", path: "/conversations/:id/messages", description: "Mensagens da conversa" },
            ]
        },
        {
            category: "Negócios",
            ...
            <div className="space-y-6">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        Integre o MelonChat com seus sistemas externos
                    </p>
                </div>
                                ...
                                <CardContent>
                                    ...
                                    <div className="flex gap-2">
                                        <code className="flex-1 bg-muted p-2 rounded text-xs truncate">
                                            {currentCompany?.id ? `sk_live_${currentCompany.id.slice(0, 8)}...` : "Carregando..."}
                                        </code>
                                        <Button size="sm" variant="outline" onClick={() => copyToClipboard(`sk_live_${currentCompany?.id}`)}>
                                    ...
                                    <CardContent>
                                        <div className="space-y-2">
                                            {category.items.map((endpoint, index) => (
                                                ...
                                                >
                                                    <Badge className={`${getMethodColor(endpoint.method)} text-white min-w-[60px] justify-center`}>
                                                        {endpoint.method}
                                                    </Badge>
