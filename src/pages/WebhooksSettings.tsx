...
import { Plus, Webhook, Trash2, RefreshCw, CheckCircle2, XCircle, Eye, EyeOff, Copy, Send } from "lucide-react";
...
const AVAILABLE_EVENTS = [
    { value: "message.received", label: "Mensagem Recebida", description: "Nova mensagem de cliente" },
    { value: "message.sent", label: "Mensagem Enviada", description: "Mensagem enviada pelo atendente" },
    { value: "conversation.created", label: "Conversa Criada", description: "Nova conversa iniciada" },
    { value: "conversation.closed", label: "Conversa Fechada", description: "Conversa foi encerrada" },
    { value: "contact.created", label: "Contato Criado", description: "Novo contato cadastrado" },
    { value: "contact.updated", label: "Contato Atualizado", description: "Dados do contato alterados" },
    ...
    { value: "proposal.viewed", label: "Proposta Visualizada", description: "Cliente viu a proposta" },
    { value: "proposal.accepted", label: "Proposta Aceita", description: "Cliente aprovou proposta" },
    { value: "proposal.rejected", label: "Proposta Rejeitada", description: "Cliente solicitou ajustes" },
];
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-2 mt-1">
                                            ...
                                            <Button size="icon" variant="ghost" onClick={() => copySecret(webhook.secret)}>
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-2 gap-2 mt-2 max-h-64 overflow-y-auto">
                                    {AVAILABLE_EVENTS.map((event) => (
                                        <div
                                            key={event.value}
                                            className={`p-3 rounded-lg border cursor-pointer transition-colors ${formData.events.includes(event.value)
