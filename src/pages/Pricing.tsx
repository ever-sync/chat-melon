      ...
      <section className="container mx-auto px-4 pt-32 pb-20">
        <div className="text-center mb-12">
          ...
          <div className="flex items-center justify-center gap-4 mb-12">
            <span className={!isYearly ? 'font-semibold' : 'text-muted-foreground'}>Mensal</span>
            <Switch checked={isYearly} onCheckedChange={setIsYearly} />
            <span className={isYearly ? 'font-semibold' : 'text-muted-foreground'}>Anual</span>
            {isYearly && (
            ...
            return (
              <Card
                ...
                className={`p-8 flex flex-col ${
                  plan.popular ? 'border-primary shadow-2xl scale-105 relative' : 'border-border/50'
                }`}
              >
                {plan.popular && (
                ...
                <div className="text-center mb-6">
                  ...
                  <div className="mb-2">
                    <span className="text-5xl font-bold">R$ {monthlyEquivalent.toFixed(2)}</span>
