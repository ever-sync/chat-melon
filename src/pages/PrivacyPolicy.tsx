      ...
      <header className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-md border-b border-slate-100">
        <div className="container mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center bg-gray-50/80 px-2 py-1.5 rounded-full border border-gray-100 shadow-sm">
            <Link
              to="/"
              className="px-5 py-2 text-sm font-medium text-slate-500 hover:text-indigo-600 rounded-full transition-all"
            >
              Home
            </Link>
            <Link
      ...
      <main className="pt-32 pb-20 container mx-auto px-6 max-w-4xl">
        ...
        <div className="prose prose-slate max-w-none text-slate-600 leading-relaxed space-y-6">
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, ou azar,
            ...
            <div className="grid md:grid-cols-4 gap-12 mb-16">
              <div className="col-span-1 md:col-span-1">
                ...
                <h3 className="text-3xl font-bold text-slate-400 leading-tight">
                  ...
                  <span className="text-slate-900">Intelligently Handled</span>
                </h3>
              </div>
