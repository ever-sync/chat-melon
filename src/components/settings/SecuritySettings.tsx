    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Gerencie autenticação, 2FA e logs de auditoria</p>
        </div>
      </div>
          ...
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground mt-1">0% dos usuários protegidos</p>
              </CardContent>
            </Card>
            ...
            <CardContent className="space-y-4">
              <div className="text-center py-8">
                ...
                <p className="text-muted-foreground mb-4">
                  Configure SSO para permitir que seus usuários façam login com o provedor de
              ...
              <div className="border-t pt-4">
                ...
                <div className="grid gap-2 md:grid-cols-4">
                  {['Google Workspace', 'Microsoft Azure AD', 'Okta', 'SAML 2.0'].map(
                    (provider) => (
                      <div key={provider} className="p-3 border rounded-lg text-center text-sm">
                        {provider}
                      </div>
                    )
                  )}
                  ...
                  {mockAuditLogs.map((log) => {
                    ...
                    return (
                      <TableRow key={log.id}>
                        ...
                        <TableCell>{log.resource_name || log.resource_type}</TableCell>
