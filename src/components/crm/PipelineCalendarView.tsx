        ...
        <div className="text-sm text-muted-foreground">
          {
            deals.filter(
              (d) =>
                d.expected_close_date && isSameMonth(new Date(d.expected_close_date), currentDate)
            ).length
          }{' '}
          negócios previstos
        </div>
                          ...
                          <div className="flex items-center gap-2 pt-2 border-t">
                            <Avatar className="h-6 w-6">
                              ...
                              <AvatarFallback className="text-[10px]">
                                {deal.profiles.full_name?.substring(0, 2).toUpperCase()}
                              </AvatarFallback>
                            </Avatar>
                            <span className="text-xs text-muted-foreground">
                              Responsável: {deal.profiles.full_name}
                            </span>
                          </div>
                        )}
