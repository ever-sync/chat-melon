          ...
          <form onSubmit={handleSubmit(handleFormSubmit)}>
            <Tabs defaultValue="geral" className="w-full">
              ...
              <TabsContent value="qualificacao" className="space-y-5 mt-6">
                ...
                {/* Budget */}
                <div className={`flex items-center justify-between p-4 border-2 rounded-lg transition-all ${watch('budget_confirmed')
                ...
                {/* Timeline */}
                <div className={`flex items-center justify-between p-4 border-2 rounded-lg transition-all ${watch('timeline_confirmed')
                  ? 'border-green-500 bg-green-50 dark:bg-green-950/20'
                  : 'border-muted bg-background'
                  }`}>
                  <div className="space-y-1">
