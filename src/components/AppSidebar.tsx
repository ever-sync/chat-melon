                        ...
                        {state === 'expanded' && (
                          <span className="flex items-center flex-1 text-[13.5px] tracking-wide">
                            ...
                            {item.comingSoon && (
                              <Badge
                                variant="outline"
                                className="ml-auto border-amber-500/30 text-amber-500 px-1.5 py-0 text-[9px] h-4 leading-none rounded-md bg-amber-500/5"
                              >
                                SOON
                              </Badge>
                            )}
              ...
              <SidebarMenu className="space-y-1.5">
                <SidebarMenuItem>
                  ...
                  >
                    ...
                    >
                      <Shield
                        className={`h-[18px] w-[18px] ${isActive('/super-admin') ? 'text-purple-400' : 'text-gray-500'}`}
                      />
