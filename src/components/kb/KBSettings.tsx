        ...
        <div className="space-y-6">
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                onChange={(e) => setSettings({ ...settings, maxTokensPerResponse: parseInt(e.target.value) })}
                            />
                        </div>
                    </div>
                </CardContent>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Configure como a IA responde às perguntas
                    </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                        ...
                        <Switch
                            ...
                            onCheckedChange={(checked) => setSettings({ ...settings, enableAutoTraining: checked })}
                        />
                    </div>
