...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      agent_performance_snapshots: {
        Row: {
          ...
          company_id: string | null
          conversations_handled_today: number | null
          created_at: string | null
      ...
      assistant_settings: {
        Row: {
          alert_customer_frustration: boolean | null
          alert_forgotten_conversations: boolean | null
          alert_quality_issues: boolean | null
          alert_slow_response: boolean | null
          company_id: string | null
          created_at: string | null
          id: string
          is_enabled: boolean | null
          ...
          show_action_suggestions: boolean | null
          show_coaching_tips: boolean | null
          show_response_suggestions: boolean | null
          slow_response_threshold: number | null
          updated_at: string | null
          user_id: string | null
        }
        Insert: {
      ...
      chatbot_ab_tests: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "chatbot_ab_tests_contact_id_fkey"
            columns: ["contact_id"]
            isOneToOne: false
            referencedRelation: "contacts"
            referencedColumns: ["id"]
      ...
      company_invites: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "company_invites_department_id_fkey"
      ...
      company_variables: {
        ...
        Relationships: [
          {
            foreignKeyName: "company_variables_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      conversations: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "conversations_tabulation_id_fkey"
            columns: ["tabulation_id"]
            isOneToOne: false
            referencedRelation: "tabulations"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      deals: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "deals_created_from_conversation_id_fkey"
      ...
      departments: {
        Row: {
          allow_view_all_contacts: boolean | null
      ...
      email_templates_visual: {
        ...
        Relationships: [
          {
            foreignKeyName: "email_templates_visual_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "email_templates_visual_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      evolution_global_config: {
        ...
        Relationships: [
          {
            foreignKeyName: "evolution_global_config_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "online_users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "evolution_global_config_updated_by_fkey"
            columns: ["updated_by"]
            isOneToOne: false
            referencedRelation: "online_users"
            referencedColumns: ["id"]
      ...
      gmail_credentials: {
        ...
        Relationships: [
          {
            foreignKeyName: "gmail_credentials_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      tabulations: {
        ...
        Relationships: [
          {
            foreignKeyName: "tabulations_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      delete_deal_note: { Args: { p_note_id: string }; Returns: boolean }
      ...
      get_agent_active_conversations: {
      ...
      get_agent_quality_score_today: {
        Args: { p_agent_id: string }
        Returns: number
      }
      get_agent_waiting_conversations: {
        Args: { p_agent_id: string; p_threshold_minutes?: number }
        Returns: number
      }
      get_agents_ranking: {
        Args: {
      ...
      get_media_public_url: { Args: { storage_path: string }; Returns: string }
      get_trial_info: {
      ...
      mark_conversation_resolved:
        ...
        | {
            Args: { p_conversation_id: string; p_tabulation_id?: string }
            Returns: Json
          }
      match_conversations: {
        Args: {
